    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 col-6 p-3">
          <img class="img-fluid d-block" src="./91租会员-各大视频会员帐号共享平台_files/youku.png">
          <div class="col-md-12">
      ...
      <div class="row notice">
        <div class="content " id="notice">
          <ul>
            ...
            <li class="item ng-scope" ng-repeat="u in bUserList" style="">
              <p class="name">用户 : <span class="ng-binding">184****9534</span></p>
              <p class="desc">参与了购买
                <!-- ngIf: u.type == 1 --><span ng-if="u.type == 1" class="ng-scope">腾讯会员</span><!-- end ngIf: u.type == 1 -->
                <!-- ngIf: u.type == 2 -->
                <!-- ngIf: u.type == 3 -->
      ...
      <div class="row vip-list">
        ...
        <div class="col-xs-4 col-md-2 l-item ng-scope" ng-repeat="v in vipList">
          <a ng-href="https://v.qq.com/" target="_blank" class="thumbnail" href="https://v.qq.com/">
            <p class="vip-logo"><img ng-src="http://static.51zuhuiyuan.com/image/v-qq.png" alt="腾讯视频" src="./91租会员-各大视频会员帐号共享平台_files/v-qq.png"></p>
        ...
        <div class="col-xs-4 col-md-2 l-item ng-scope" ng-repeat="v in vipList">
          <a ng-href="http://www.youku.com/" target="_blank" class="thumbnail" href="http://www.youku.com/">
            <p class="vip-logo"><img ng-src="http://static.51zuhuiyuan.com/image/youku.png" alt="优酷视频" src="./91租会员-各大视频会员帐号共享平台_files/youku(1).png"></p>
        ...
        <div class="col-xs-4 col-md-2 l-item ng-scope" ng-repeat="v in vipList">
          <a ng-href="http://www.le.com/" target="_blank" class="thumbnail" href="http://www.le.com/">
            <p class="vip-logo"><img ng-src="http://static.51zuhuiyuan.com/image/le.png" alt="乐视视频" src="./91租会员-各大视频会员帐号共享平台_files/le.png"></p>
            <p class="name ng-binding">乐视视频</p>
          </a>
        </div><!-- end ngRepeat: v in vipList -->
      </div>
    </div>
  </div>
  <script src="./91租会员-各大视频会员帐号共享平台_files/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
  <script src="./91租会员-各大视频会员帐号共享平台_files/popper.min.js" integrity="sha384-wHAiFfRlMFy6i5SRaxvfOCifBUQy1xHdJ/yoi7FRNXMRBu5WHdZYu1hA6ZOblgut" crossorigin="anonymous"></script>
  <script src="./91租会员-各大视频会员帐号共享平台_files/bootstrap.min.js" integrity="sha384-B0UglyR+jN6CkvvICOB2joaf5I4l3gm9GU6Hc1og6Ls7i6U/mkkaduKaBhlAXv9k" crossorigin="anonymous"></script>
  <pingendo onclick="window.open(&#39;https://pingendo.com/&#39;, &#39;_blank&#39;)" style="cursor:pointer;position: fixed;bottom: 20px;right:20px;padding:4px;background-color: #00b0eb;border-radius: 8px; width:220px;display:flex;flex-direction:row;align-items:center;justify-content:center;font-size:14px;color:white">Made with Pingendo Free&nbsp;&nbsp;<img src="./91租会员-各大视频会员帐号共享平台_files/Pingendo_logo_big.png" class="d-block" alt="Pingendo logo" height="16"></pingendo>
